...
class DecisionExplainer:
    ...
    _POLICY_LABELS = {
        ...
        "PRICE-001": (
            "Price change exceeds 30% single-decision limit",
        ...
        "PRICE-002": (
            "New price is below floor price",
        ...
        "FIN-004": (
            "Currency transaction at BSA reporting threshold",
        ...
        "TRADE-001": (
            "Trading position notional exceeds limit",
        ...
        "TRADE-002": (
            "Order quantity is a potential fat-finger error",
            [
        ...
        "GEN-001": (
            "Generated content contains detected PII",
        ...
        "LEGAL-002": (
            "Legal hold applies to the requested action",
        ...
        "RISK-001": (
            "Aggregated component risk exceeds the configured threshold",
    ...
    def explain(self, response: "DecisionResponse", level: str = "STANDARD") -> DecisionExplanation:
        ...
        if response.audit_record and response.audit_record.risk_result:
            ...
            if rr.factors:
                ...
                sorted_factors = sorted(rr.factors, key=lambda f: f.score * f.weight, reverse=True)
        ...
        if why_blocked:
            ...
            paragraphs.append(
                f"The governance pipeline blocked this decision because: {block_detail}."
            )

        if risk_breakdown and level in ("STANDARD", "DETAILED"):
            rb = "; ".join(risk_breakdown)
            paragraphs.append(
                f"Risk scoring: composite score {risk_score:.0f}/100. "
